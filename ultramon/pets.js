...
const PETS = {
    flaragon: {
        ...
        baseStats: { hp: 50, attack: 10, defense: 10, spAttack: 16, spDefense: 12, speed: 15 },
        maxStats:  { hp: 250, attack: 110, defense: 120, spAttack: 190, spDefense: 140, speed: 175 },
        moves: [
            { name: "Scratch", type: "basic", damage: 15, powerCost: 0, damageType: "physical", levelToLearn: 1 },
    ...
    bubbitty: {
        ...
        baseStats: { hp: 55, attack: 10, defense: 14, spAttack: 12, spDefense: 16, speed: 10 },
        maxStats:  { hp: 270, attack: 130, defense: 170, spAttack: 150, spDefense: 195, speed: 240 },
        moves: [
    ...
    sproupup: {
        ...
        baseStats: { hp: 60, attack: 16, defense: 13, spAttack: 8, spDefense: 10, speed: 12 },
        maxStats:  { hp: 300, attack: 185, defense: 155, spAttack: 100, spDefense: 130, speed: 145 },
        moves: [
            { name: "Tackle", type: "basic", damage: 15, powerCost: 0, damageType: "physical", levelToLearn: 1 },
    ...
    sparkwing: {
        ...
        baseStats: { hp: 45, attack: 13, defense: 8, spAttack: 17, spDefense: 9, speed: 18 },
        maxStats:  { hp: 230, attack: 150, defense: 105, spAttack: 205, spDefense: 115, speed: 210 },
        moves: [
    ...
    coalapling: {
        ...
        baseStats: { hp: 60, attack: 17, defense: 25, spAttack: 17, spDefense: 25, speed: 10 },
        maxStats:  { hp: 290, attack: 150, defense: 180, spAttack: 150, spDefense: 180, speed: 120 },
        moves: [
    ...
    samupillar: {
        ...
        baseStats: { hp: 45, attack: 15, defense: 12, spAttack: 12, spDefense: 5, speed: 5 },
        maxStats:  { hp: 220, attack: 125, defense: 120, spAttack: 95, spDefense: 60, speed: 100 },
        moves: [
